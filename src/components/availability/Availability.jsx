...
function Availability() {
  return (
    <div id="page5" className="w-screen">
      ...
      <div
        id="page5_image_box"
        className="w-screen h-[85vh] px-[5vw] flex items-center justify-evenly font-dancing"
      >
        {/* Bottle 1 */}
        <div
          id="page5_bottel"
          className="w-[15vw] h-[60vh] flex flex-col items-center justify-center"
        >
          <img
            id="image11"
            src="img/image1.png"
            alt=""
            className="h-[48vh] w-[15vw]"
          />
        ...
        >
          <img
            ...
            src="img/image2.png"
            alt=""
            className="w-[15vw] rotate-[-15deg] ml-12"
          />
          <h4 className="font-Dosis text-center mt-2">22 oz Bottles</h4>
          <h6 className="font-Gilroy text-[1.1vmax] mt-1 flex justify-around">
            6-PACK
          </h6>
        </div>
        ...
        >
          <img
            ...
            src="img/ipa.png"
            alt=""
            className="h-[51vh] w-[15vw] rotate-[-15deg] opacity-0"
          />
          <h4 className="font-Dosis text-center mt-2">22 oz Bottles</h4>
          <h6 className="font-Gilroy text-[1.1vmax] mt-1 flex justify-around">
            6-PACK
        ...
        >
          <img
            ...
            src="img/image3.png"
            alt=""
            className="w-[15vw] rotate-[-15deg] ml-8"
          />
